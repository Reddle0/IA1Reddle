...
# Preventing revisits if Kacey is at her apartment #
init 100 python:
...
## Adding the scene to required lists ##
init 400 python:
# Dream Replay Scene #
    leftovers_old_julia_swimsuit_replayable_scene_choice_label = Julia.replayable_scene_choice_label

    def leftovers_julia_swimsuit_replayable_scene_choice_label(self, scene_name):
        if scene_name == "julia_scene_swimsuit":
            return "When I bought a swimsuit for " + julia.say_name + "..."

        return leftovers_old_julia_swimsuit_replayable_scene_choice_label(self, scene_name)

    Julia.replayable_scene_choice_label = leftovers_julia_swimsuit_replayable_scene_choice_label

# Revisit Choice #
init 500 python:
    old_julia_swimsuit_revisitable_scene_choice_label = Julia.revisitable_scene_choice_label

    def julia_swimsuit_revisitable_scene_choice_label(self, scene_name):
        if scene_name == "julia_scene_swimsuit":
            if "julia_scene_swimsuit_revisit" in scenes_completed:
                ...
                elif "julia_scene_swimsuit_revisit_first_time_nude" in scenes_completed:
        ...
        return old_julia_swimsuit_revisitable_scene_choice_label(self, scene_name)

    Julia.revisitable_scene_choice_label = julia_swimsuit_revisitable_scene_choice_label
...
init 400 python:
    ...
    def leftovers_mod_julia_swimsuit_gallery_images(self):
        ...
        if "julia_scene_swimsuit" in scenes_completed and "julia_scene_footjob" in scenes_completed:
            images.append("mods/leftovers_mod/images/bg/julia/julia_swimsuit/bg julia_swimsuit_read_nude.png")
        ...
        if "julia_scene_swimsuit_revisit_first_time_vaginal" in scenes_completed and "julia_scene_vaginal" in scenes_completed:
            ...
            images.append("mods/leftovers_mod/images/bg/julia/julia_swimsuit/bg julia_swimsuit_vaginal_spread.png")
            images.append("mods/leftovers_mod/images/bg/julia/julia_swimsuit/bg julia_swimsuit_vaginal_spread_nude.png")
            ...
            images.append("mods/leftovers_mod/images/bg/julia/julia_swimsuit/bg julia_swimsuit_cum.png")
            images.append("mods/leftovers_mod/images/bg/julia/julia_swimsuit/bg julia_swimsuit_cum_nude.png")
...
init 100 python:
    ...
    def vicky_display_menu(self):
        # rebuild her speaking characters right before her custom menu opens.
        # that makes sure vicky.c is using the auto-highlight callback version.
    ...
    def kacey_display_menu(self):
        # same idea for kacey.
        # her modded menu/bust setup is custom too, so refresh her speaking object here.
        self.create_renpy_characters()
