...
init 200:
    screen splash_text_leftovers:
        vbox:
            ...
            text "{b}Leftovers Mod Detected!{/b}" size 40 xalign 0.5
            text "See Below:" size 32 xalign 0.5
            text "This mod is currently a work-in-progress!" size 24 xalign 0.5
            text "Planned CGs are currently not complete yet, so this build has excluded them for now until they are ready." size 24 xalign 0.5
            text "The scenes themselves however are fully playable, but I've locked it behind a \"See Incomplete Mod Content\" option in Nate's bedroom." size 24 xalign 0.5
            text "Please do not report any missing CGs as bugs!" size 24 xalign 0.5
            text "Report any issues to the IA Discord, and/or Reddle's IA1 Mods Empornium." size 24 xalign 0.5
...
label finale_scene_leftovers_sex(dream = False):
    ...
    if finale_julia_sam and "julia_scene_swimsuit" in store.scenes_completed:
        ...
        janet.c "This is the first time in a while I've seen her wear a swimsuit."
        ...
        if "sam_scene_swimsuit" in store.scenes_completed:
            ...
            sa.c "She was shy about wearing it in front of everybody."

            call process_character(sa, appearance = "outfit swimsuit pose handsbehind face happy blush false")
            sa.c "But I helped her ease into it!"

            call process_character(julia, appearance = "outfit swimsuit pose handface face embarrassed blush false")
            julia.c "..."

            call process_character(julia, appearance = "outfit swimsuit pose handface face embarrassed blush false")
            julia.c "She was very... {w=0.5}persistent about it."

            call process_character(sa, appearance = "outfit swimsuit pose leaning face happy blush false")
            sa.c "I gave her some inspiring words of encouragement!"
