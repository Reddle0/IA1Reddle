...
label julia_scene_swimsuit_sex(dream = False):
    ...
    call process_character(n, appearance = "pose handpocket face curious")
    n.c "And you don't have to swim with it on either."

    call process_character(n, appearance = "pose handpocket face neutral")
    n.c "You could just wear it by the pool."
    ...
    call process_character(julia, appearance = "pose handface face neutral")
    julia.c "(And like he said, it might be good if I want to read outside)"

## conditional
    if "julia_scene_topless" in scenes_completed:
        call process_character(julia, appearance = "pose handface face angry")
        julia.c "(Last time my clothes got soaked by his sister's cannonball...)"
        ...
        call process_character(julia, appearance = "pose handface face neutral")
        julia.c "(And it'd save me from getting my clothes wet if I'm sitting next to the pool)"
    ...
    call process_scene_beginning(bg = "bg backyard_daytime", char_tuple_array = [ (n, "outfit swimsuit pose behindhead face curious")], dream = dream, force_bg_change = True)
    ...
    call process_character(julia, appearance = "outfit swimsuit pose armcross face embarrassed")
    julia.c "..."

    call process_character(n, appearance = "pose behindhead face curious")
    n.c "What's the matter?"

    call process_character(n, appearance = "pose behindhead face curious")
    n.c "Do you not like it?"

    call process_character(julia, appearance = "outfit swimsuit pose armcross face neutral")
    julia.c "...{p}..."

    call process_character(julia, appearance = "pose armcross face happy blush false")
    julia.c "Actually... {w=1.0}quite the opposite."
    ...
    call process_character(n, appearance = "pose twohandfist face neutral")
    n.c "\"Exclusive\" sounded like the kind of thing you'd like."
    ...
    call process_character(julia, appearance = "pose armcross face neutral")
    julia.c "I'm asking because it feels different."

    call process_character(n, appearance = "pose behindhead face curious")
    n.c "Different how?"

    call process_character(julia, appearance = "pose handup face neutral")
    julia.c "For starters, it's lighter than I expected."

    call process_character(julia, appearance = "pose handup face neutral")
    julia.c "Softer, too."

    call process_character(julia, appearance = "pose handface face curious")
    julia.c "I'm honestly surprised it fits me as well as it does."

    call process_character(julia, appearance = "pose handface face embarrassed")
    julia.c "I was worried all these straps would make it feel like a harness."
    ...
    call process_character(julia, appearance = "pose handup face curious")
    julia.c "{w=0.5}Nylon and elastane..."
...
label julia_scene_swimsuit_revisit:
    ...
    if "julia_scene_vaginal" and "julia_scene_swimsuit_revisit_first_time_normal" in scenes_completed:
        ...
        if "julia_scene_swimsuit_revisit_first_time_nude" in scenes_completed:
...
label julia_scene_swimsuit_revisit_first_time_vaginal:
    call process_scene_beginning(bg = backyard, char_tuple_array = [(n, "outfit swimsuit pose handsdown face neutral blush false")])
    ...
    call process_character(julia, appearance = "outfit swimsuit pose armcross face neutral blush false")
    julia.c "It's still not my thing."
    ...
    call process_character(julia, appearance = "outfit swimsuit pose handface face curious blush false")
    julia.c "(Is he... {w=0.5}staring at my swimsuit?)"
    ...
    call process_character(n, appearance = "outfit swimsuit_hard pose handfist face embarrassed blush true")
    ...
    julia.c "To fuck me while I wear this."
    julia.c "Right here, on this deck chair."
    n.c "..."
    n.c "Y-Yeah..."
    n.c "..."
    n.c "I-I do, [julia.say_name]."
    ...
    julia.c "You picked a good time to pull this one, you know."
    ...
    julia.c "That can only mean one thing..."
    n.c "Ah, oh!"
    n.c "Mhm..."
    n.c "(It can't be much longer...)"
    n.c "(My penis feels really hot!)"
    n.c "(I-I don't know I can hold on...)"
    n.c "Oh!"
    n.c "Mmngh!"
    julia.c "(Huh?)"
    julia.c "(He's pulling out?)"
    julia.c "{cps=40}(Why is he-{/cps}{w=0.75}{nw})"
    ...
    n.c "Mmn..."
    julia.c "(Gah!)"
    julia.c "(That's a lot of cum!)"
    julia.c "(Fuck, it's gonna go all over my top!)"
    ...
    julia.c "It's all over my top."
    julia.c "Let's hope it doesn't end up on the deck chair."
    julia.c "Those balls of yours must have been backed up."
    n.c "Y-yeah, maybe..."
    julia.c "..."
    julia.c "So why did you pull out, [n.say_name]?"
    n.c "..."
    n.c "I don't really know..."
    n.c "I just couldn't hold it in, I guess."
    julia.c "Or you wanted to mark me."
    n.c "M-mark you?"
    julia.c "Like how animals mark their territory."
    julia.c "It's a way of establishing power over others."
    n.c "Oh..."
    julia.c "You acted on impulse, so it's hard to say what you really had in mind."
    julia.c "But what you did..." 
    julia.c "It went beyond just being assertive."
    julia.c "You showed dominance, [n.say_name]. \nYou left your mark on me, quite literally."
    n.c "..."
    julia.c "You... {w=0.5}claimed me as your own."
    julia.c "Even if you didn't realize it."
    n.c "Woah..."
    n.c "I never thought about it like that..."
    julia.c "So, what do you think, [n.say_name]?"
    julia.c "Did you mean to mark me, or was it just an accident?"
    n.c "..."

    menu:
        "I don't know...":
            n.c "It just kinda happened."
            n.c "I-I didn't really think about it, I guess."
        "M-maybe a bit of both.":
            n.c "Well..."
            n.c "Now that you mention it..."
            n.c "Maybe there was a part of me that wanted that too?"

    julia.c "..."
    julia.c "Interesting."
    julia.c "You know, it's a bit... {w=0.5}thrilling, actually."
    julia.c "Knowing that you wanted to leave your mark on me like that."
    julia.c "That's the side of you I'm always eager to see."

    $ renpy.pause(1)
    julia.c "Well."
    julia.c "That was certainly an unique experience."
    ...
    julia.c "We should."
    julia.c "I can't help but be curious about what other surprises you have in store for me."
...
label julia_scene_swimsuit_revisit_second_time_vaginal:
    ...
    call static_still_ctc("bg julia_swimsuit_fuck_nude_blur" if julia_scene_swimsuit_revisit_nude else "bg julia_swimsuit_fuck_blur")
    ...
    n.c "Hey, [julia.say_name]..."
    julia.c "Yeah?"
    n.c "Maybe you could try doing this without your bathing suit too."
    julia.c "That's an interesting idea, [n.say_name]."
    julia.c "I absolutely could."
    ...
    menu:
        ...
        "Actually, y-you're fine as is.":
            julia.c "Sure, if you say so."
            julia.c "What we're doing is already risky enough."
            julia.c "Might be {i}too{/i} risky if I got naked as well."
...
label julia_scene_swimsuit_revisit_first_time_nude:
    call process_scene_beginning(bg = backyard, char_tuple_array = [(n, "outfit swimsuit pose behindhead face curious blush false")])
    ...
    $ scenes_completed.add("julia_scene_swimsuit_revisit_first_time_nude")
    call julia_scene_swimsuit_revisit_end
    return

label julia_scene_swimsuit_revisit_second_time_nude:
    $ no_bust_art = False
    call process_character(n, appearance = "outfit swimsuit pose behindhead face curious blush false")

    call process_character(n, appearance = "outfit swimsuit pose behindhead face curious blush true")
    n.c "..."
    ...
    $ scenes_completed.add("julia_scene_swimsuit_revisit_second_time_nude")
...
label julia_scene_swimsuit_revisit_first_time_normal:
    ...
    call static_still_ctc("bg julia_swimsuit_read")
    # poses go unused, they were used before the CG existed

    call process_character(julia, appearance = "outfit swimsuit pose handface face happy blush false")
    julia.c "\"Cutlass & Conjure\"."
    ...
    call process_character(julia, appearance = "outfit swimsuit pose armcross face neutral blush false")
    julia.c "Yeah, I thought so too..."

    call process_character(julia, appearance = "outfit swimsuit pose armcross face neutral blush false")
    julia.c "But I've had just as much difficulty reading indoors as well, lately."
    ...
    call process_character(julia, appearance = "outfit swimsuit pose handface face neutral blush false")
    julia.c "If things still get too bad even under the umbrella, I've got sunglasses next to me."
...
label julia_scene_swimsuit_revisit_second_time_normal:
    ...
    call process_character(julia, appearance = "pose handface face happy blush false")
    julia.c "I'll be out in a bit. Wait for me."
    ...
    call process_character(julia, appearance = "outfit swimsuit pose handup face neutral blush false")
    julia.c "Looks like it's just us again."
    
    call process_character(julia, appearance = "outfit swimsuit pose armcross face neutral blush false")
    julia.c "Is it usually like this when you're out here?"
    
    call process_character(n, appearance = "outfit swimsuit pose handsdown face neutral blush false") 
    n.c "Sometimes, yeah."
    
    call process_character(n, appearance = "outfit swimsuit pose handfist face neutral blush false")
    n.c "[sa.say_name] likes to come out here too."
    
    call process_character(n, appearance = "outfit swimsuit pose handfist face neutral blush false") 
    n.c "She loves making up new challenges we can do while we're in the water."
    
    call process_character(julia, appearance = "outfit swimsuit pose handface face curious blush false") 
    julia.c "Challenges?"
    
    call process_character(n, appearance = "outfit swimsuit pose handsdown face neutral blush false") 
    n.c "Like creating the biggest splash we can."

    if "sam_scene_swimsuit_revisit_first_time_normal" in store.scenes_completed:
        call process_character(n, appearance = "outfit swimsuit pose behindhead face curious blush false") 
        n.c "Or planning our plan of entry..."

    call static_still_ctc("bg julia_swimsuit_read")
    julia.c "You know, I'm starting to get used to this."
    julia.c "It's really not so bad out here."
    julia.c "Good thing there's plenty of shade too."
    julia.c "Makes reading a breeze."
