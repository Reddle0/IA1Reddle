...
screen blackjack_betting_screen(p_player_money, p_total_bet):
    ...
    vbox:
        ...
        text "Your Money: {color=#00FF00}$[p_player_money]{/color}" size 40 color "#ffffff" xalign 0.5 style "blackjack_gui_text"
        text "Current Bet: {color=#00FF00}$[p_total_bet]{/color}" size 50 color "#FFD700" xalign 0.5 style "blackjack_gui_text"
