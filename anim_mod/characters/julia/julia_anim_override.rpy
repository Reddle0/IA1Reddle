...
label julia_scene_anal_revisit_anim_mod:
    $ renpy.start_predict("julia_vaginal_anim")

    if "julia_scene_anal_revisit" not in scenes_completed:
        call julia_scene_anal_revisit_1st_time_anim_mod
    else:
        call julia_scene_anal_revisit_2nd_time_anim_mod
...
label julia_scene_anal_revisit_1st_time_phase_3_anim_mod:
    ...
    call julia_scene_anal_revisit_end_anim_mod
