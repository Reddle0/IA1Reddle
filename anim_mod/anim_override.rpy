init offset = 99
default anim_mod_detected = True
...
label character_gallery_fullscreen_anim_mod(character_gallery_fullscreen_image, gallery_char, gallery_char_page):
    python:
        ...
        # new anims for leftovers 0.4
        elif "vicky_anal_anim_1" in character_gallery_fullscreen_image:
            character_gallery_fullscreen_image = "vicky_anal_anim"        
        elif "edna_blowjob_anim_0" in character_gallery_fullscreen_image:
            character_gallery_fullscreen_image = "edna_blowjob_anim"  
